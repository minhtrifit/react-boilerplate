export const APP_ROUTE = {
  ...
  ADD_PRODUCT: '/management/products/create',
  EDIT_PRODUCT: '/management/products/edit/:id',
  DETAIL_PRODUCT: '/management/products/detail/:id',
  CARTS: '/management/carts',
  ADD_CART: '/management/carts/create',
  BLOGS: '/management/blogs',
  ADD_BLOG: '/management/blogs/create',
  DETAIL_BLOG: '/management/blogs/detail/:id',
  ROLES: '/roles',
